      ...
      <PerfectScrollbar component="div">
        <div className="contentContainer details">
          ...
          <div className="details__right">
            ...
            <div className="text1">
              {" "}
              Eiusmod consectetur ullamco nostrud nisi laborum ullamco nulla non
              est velit.{" "}
            </div>
            <div className="action">
              <button onClick={this.editStory}>Редактировать</button>
            </div>
          </div>
          <div className="details__left">
            <div className="details__title main1">Заголовок</div>
            <div />
            <div className="desk text1">
              {" "}
              Eiusmod consectetur ullamco nostrud nisi laborum ullamco nulla non
              est velit.Eiusmod consectetur ullamco nostrud nisi laborum ullamco
              nulla non est velit.Eiusmod consectetur ullamco nostrud nisi
              laborum ullamco nulla non est velit.
            </div>
          </div>
        </div>
      </PerfectScrollbar>
