...
export default class InvitationForm extends Component {
  ...
  render() {
    ...
    const displayTooltipEmail =
      email.length === 0 || email === null || emailValid
        ? "formErrors displayNone"
        : "formErrors";
    const inputEmail =
      email.length > 0 && !emailValid
        ? "textInput input_color_red"
        : "textInput";
    return (
      <div className="formWrapper">
        <div className="formWrapperItem__titleContainer">
          <h2 className="textBasic titleContainerItem__title titleContainer_indent">
            Пригласите друга
          </h2>
          <p className="textBasic">
            Пригласите своего близкого человека,
            <br /> чтобы он&nbsp;стал частью вашей истории
          </p>
        </div>
        <form
          className="formContainerItem__form formContainerItem_indent"
          action="/"
          method="POST"
        >
          <input
          ...
          <div className="formContainerItem__icons formContainerItem__icons_indent">
            <a href="https://vk.com/" alt="vk">
              <FormVK />
            </a>
            <a href="https://www.instagram.com/" alt="ins">
              <FormIns />
            </a>
            <a href="https://ru-ru.facebook.com/" alt="facebook">
              <FormFB />
            </a>
