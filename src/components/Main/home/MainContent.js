    ...
    <div className="contentContainer">
      <div className="MainContent__header">
        <div className="MainContent__header-info">
          <h2 className="MainContent__header-titel">Здравствуйте!</h2>
          <p className="MainContent__header-text">
            Давайте вместе создадим вашу историю, чтобы остаться в памяти у
            потомков!
          </p>
          <Link to="/photo/add">
            <ButtonContainer white={false}>Загрузить фото</ButtonContainer>
          </Link>
        </div>
      ...
      <div className="mainContainer">
        ...
        <div className="mainContainer__item div2 basicItem">
          ...
          <ButtonContainer className="btn-position">
            {" "}
            Пригласить
          </ButtonContainer>
        </div>
