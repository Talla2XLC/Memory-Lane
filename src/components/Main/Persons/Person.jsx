...
class Person extends Component {
  ...
  render() {
    ...
    const day = currentPerson.birthday
      ? currentPerson.birthday.substr(8, 2)
      : "";
    const month = currentPerson.birthday
      ? currentPerson.birthday.substr(5, 2)
      : "";
    const year = currentPerson.birthday
      ? currentPerson.birthday.substr(0, 4)
      : "";
    ...
    return !edit ? (
      <div className="person">
        <div className="head1 title">
          {currentPerson.last_name} {currentPerson.first_name}{" "}
          {currentPerson.patronymic}
        </div>
        <div className="personInfo">
          <div className="head3 title">Главное фото</div>
          <img
            className="personInfo__ico"
            src={currentPerson.ico_url}
            alt="persons icon"
          />
          <div className="personInfo__text">
            <div className="personInfo__item">
              ...
              <div className="textTransform">
                {currentPerson.gender === "male" ? "мужчина" : "женщина"}
              </div>
            </div>
            <div className="personInfo__item">
              <div className="infoGroup__name">Степень родства: </div>
              <div className="textTransform">
                {currentPerson.role_in_family}
              </div>
            </div>
            <div className="personInfo__item">
          ...
          <ButtonContainer className="person__button" onClick={this.editOn}>
            Редактировать
          </ButtonContainer>
          <Link to={"/persons/"}>
            <ButtonContainer
        ...
        <PersonsContent images={images} />
      </div>
    ) : (
      <EditPerson currentId={currentId} currentPerson={currentPerson} />
    );
  }
}
