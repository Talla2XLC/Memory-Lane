...
class UsersAlbums extends Component {
  state = {
	...
	addAlbum = () => {
	  ...
	  // const token = this.props.isAuthorized;
	...
	render() {
	  const { albumName, description } = this.state;
		const userAlbums = Object.values(this.props.albums);
...
const mapStateToProps = (state) => {
  return {
    isAuthorized: state.session.sessionID,
...
export default connect(mapStateToProps, mapDispatchToProps)(UsersAlbums);
