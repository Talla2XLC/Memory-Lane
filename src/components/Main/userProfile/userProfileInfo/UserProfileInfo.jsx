  ...
  render() {
    ...
    return (
      <div className="UserProfileInfo">
        <h2 className="UserProfileInfo__titel">
        ...
        <ul className="UserProfileInfo__list">
            ...
            <div>
              ...
              <div>
                <label className="UserProfileInfo__checkbox">
                  ...
                  <span className="UserProfileInfo__checkbox-text">
                    {" "}
          ...
          <li className="UserProfileInfo__item">
            ...
            <div className="UserProfileInfo__item-rate">
              <span>{/*Стандарт*/}</span>
              <span className="UserProfileInfo__item-change">
                Сменить тариф
              </span>
            </div>
          </li>
        ...
        <button
          className="UserProfileInfo__btn"
          onClick={() => this.handleSetEditing(true)}
        >
