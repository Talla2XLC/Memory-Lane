...
class AddPerson extends Component {
  ...
  addPerson = () => {
    ...
    axios
      .post("http://api.memory-lane.ru/db/setPerson", data, {
        headers: {
      ...
      <div className="setPersonContainer">
        ...
        <div className="setPerson">
          <div className="setPerson__ico">
            <img
              className="setPerson__img"
              src={
                imagesToUpload.length > 0
                  ? this.state.imagesToUpload[0].preview
                  : "http://placehold.it/365x365"
              }
              alt="persons icon"
            />
          ...
          <div className="setPerson__text">
            <div className="infoGroup">
              <label className="infoGroup__name" htmlFor="lastName">
                Фамилия:
              </label>
              <input
                name="lastName"
            ...
            <div className="infoGroup">
              <label className="infoGroup__name" htmlFor="firstName">
                Имя:
              </label>
              <input
                id="firstName"
            ...
            <div className="infoGroup">
              <label className="infoGroup__name" htmlFor="patronymic">
                Отчество:
              </label>
              <input
                id="patronymic"
            ...
            <div className="infoGroup">
              <label className="infoGroup__name" htmlFor="gender">
                Пол:
              </label>
            ...
            <div className="infoGroup">
              <label htmlFor="birthday" className="infoGroup__name">
                Дата рождения:
              </label>
              <input
            ...
            <div className="infoGroup">
              <label className="infoGroup__name" htmlFor="city">
                Место рождения:
              </label>
              <input
                name="city"
            ...
            <Link className="setPerson__button" to={"/persons/"}>
              <ButtonContainer onClick={this.addPerson}>
                Сохранить
              </ButtonContainer>
            </Link>
