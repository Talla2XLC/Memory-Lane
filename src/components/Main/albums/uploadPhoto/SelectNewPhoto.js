    ...
    return (
      <div className="contentContainer">
        <div className="addPhotoWrap">
          <div className="head1 albumTitle">Загрузка фотографий</div>
          <div className="upload-albumName">
            <div className="text1 albumDesc">Альбом для загрузки фото</div>
            <div className="albums-select text1">
              <span className="selected-album">
          ...
          <div className="choicePhoto">
            ...
            {(imagesToUpload ? imagesToUpload.length : false) > 0 &&
            selectedAlbum ? (
              <ButtonContainer
                className="choicePhoto__button"
